...
#if defined(NDEBUG)
# error "KHcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "KHcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s KHC additional fees, %d delta bytes\n",
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
	...
	nSubsidy = 0; // for distribute in Cambodia via ICO
    }
