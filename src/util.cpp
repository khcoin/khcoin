...
const char * const BITCOIN_CONF_FILENAME = "khcoin.conf";
const char * const BITCOIN_PID_FILENAME = "khcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "KHcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/KHcoin";
#else
    // Unix
    return pathRet / ".khcoin";
#endif
#endif
}
